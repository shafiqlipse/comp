...
# Create your models here.
class Basketball5(models.Model):
    name = models.CharField(max_length=255)
    championship = models.ForeignKey(
        Championship, on_delete=models.CASCADE, related_name="basketball5"
    )
    season = models.ForeignKey(
        Season, on_delete=models.CASCADE, related_name="basketball5"
    )
...
class B5Group(models.Model):
    competition = models.ForeignKey(
        Basketball5, on_delete=models.CASCADE, related_name="b5comp"
    )
    name = models.CharField(max_length=255)
    teams = models.ManyToManyField(SchoolTeam)
...
class B5Fixture(models.Model):
    ...
    team2 = models.ForeignKey(
        SchoolTeam, related_name="b5team2", on_delete=models.CASCADE
    )
